...
class worker_node(Node):
    ...
    def execute_blocks(self):
        ...
        # Block Name: CF1 GOTO1
        start_time = 3.10
        self.timeHelper.sleepUntil(start_time)
        goto_duration(groupState, -3.5,2.5,2,4)
        ...
        # Block Name: CF1 To Wall
        start_time = 16.55
        self.timeHelper.sleepUntil(start_time)
        goto_duration(groupState, -5.5,2,2,5)
